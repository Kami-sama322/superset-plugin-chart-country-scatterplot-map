...
- Кросс-фильтры дашборда: клик по региону (или баблу) фильтрует другие чарты по **Entity**; повторный клик снимает фильтр. Выбранный регион — жирная обводка и zoom
